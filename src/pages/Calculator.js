document.getElementById('metaForm').addEventListener('submit', function(event) {
  ...
  if (valorAtingido >= valorMeta) {
      ...
      mensagemFinal = 'Você está muito perto de sua meta financeira! Com alguns ajustes nas contribuições ou na duração, você pode alcançar o valor exato desejado.';
  }
